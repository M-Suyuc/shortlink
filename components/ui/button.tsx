...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-neutral-200 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-neutral-800',
  {
    variants: {
      variant: {
        default:
